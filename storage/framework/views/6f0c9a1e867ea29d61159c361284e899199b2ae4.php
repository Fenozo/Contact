                        ...
                        <div class="col-md-9">
                            <article>
                                ...
                                <div class="how">
                                    ...
                                    <div>
                                        <a href="<?php echo e(route('show_details', ['id'=> $url->shortened])); ?>" style="color:#5bc0de;">show</a>
                                    </div>
                                </div>
                            </article>
                        </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\UrlShortener\resources\views/page/url/showOrcreate.blade.php ENDPATH**/ ?>